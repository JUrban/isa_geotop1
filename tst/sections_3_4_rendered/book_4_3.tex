...
\begin{center}
\fbox{\parbox{0.82\linewidth}{\centering \emph{Figure 4.2 omitted in this rendered excerpt; see the raw book source above.}}}
\end{center}
...
\begin{center}
\fbox{\parbox{0.82\linewidth}{\centering \emph{Figure 4.3 omitted in this rendered excerpt; see the raw book source above.}}}
\end{center}
...
\begin{center}
\fbox{\parbox{0.82\linewidth}{\centering \emph{Figure 4.4 omitted in this rendered excerpt; see the raw book source above.}}}
\end{center}
