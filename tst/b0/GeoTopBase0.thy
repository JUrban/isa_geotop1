...
proof -
  (** Phase 8 reproof: use geotop_common_subdivision_finite directly,
      bypassing the FALSE iterated-Sd theorem. **)
  ...
  have hL2_simp: "geotop_is_complex L2"
    using hL2 unfolding geotop_is_subdivision_def by (by100 blast)
  ...
  have hpoly: "geotop_polyhedron L1 = geotop_polyhedron L2"
    using hL1_poly hL2_poly by (by100 simp)
