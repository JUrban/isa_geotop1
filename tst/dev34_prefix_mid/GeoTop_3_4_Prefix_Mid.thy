                            ...
                            proof -
                              ...
                              proof -
                                ...
                                show "e \<inter> closed_segment v\<^sub>0 v\<^sub>2 \<noteq> {}"
                                  using hxe hx_chord by (by100 blast)
                              qed
                              have hL\<^sub>1_side_edge_nonparent_has_off_parent_chord_point:
                                "\<And>e. e \<in> L\<^sub>1 \<Longrightarrow> geotop_is_edge e \<Longrightarrow>
                                  geotop_is_face e \<sigma> \<Longrightarrow> e \<subseteq> J\<^sub>1 \<Longrightarrow>
                                  \<not> e \<subseteq> J' \<Longrightarrow>
                                  \<exists>x. x \<in> e \<and> x \<in> closed_segment v\<^sub>0 v\<^sub>2
                                    \<and> x \<notin> J'"
                              proof -
                                fix e
                                assume he_sub_J\<^sub>1: "e \<subseteq> J\<^sub>1"
                                ...
                                have hx_chord: "x \<in> closed_segment v\<^sub>0 v\<^sub>2"
                                  using he_sub_parent_or_chord hxe hx_not_parent by (by100 blast)
                                show "\<exists>x. x \<in> e \<and> x \<in> closed_segment v\<^sub>0 v\<^sub>2
                                  \<and> x \<notin> J'"
                                  using hxe hx_chord hx_not_parent by (by100 blast)
                              qed
                              have hL\<^sub>2_side_edge_nonparent_has_off_parent_chord_point:
                                "\<And>e. e \<in> L\<^sub>2 \<Longrightarrow> geotop_is_edge e \<Longrightarrow>
                                  geotop_is_face e \<tau> \<Longrightarrow> e \<subseteq> J\<^sub>2 \<Longrightarrow>
                                  \<not> e \<subseteq> J' \<Longrightarrow>
                                  \<exists>x. x \<in> e \<and> x \<in> closed_segment v\<^sub>0 v\<^sub>2
                              ...
                              proof -
                                ...
                                show "\<exists>x. x \<in> e \<and> x \<in> closed_segment v\<^sub>0 v\<^sub>2
                                  ...
                                  using hxe hx_chord hx_not_parent by (by100 blast)
                              qed
                              have h\<sigma>_side_edge_nonparent_has_off_parent_chord_point:
                                "\<And>e. e \<in> L\<^sub>1 \<Longrightarrow> geotop_is_edge e \<Longrightarrow>
                                  geotop_is_face e \<sigma> \<Longrightarrow> e \<subseteq> J\<^sub>1 \<Longrightarrow>
                                  \<not> e \<subseteq> J' \<Longrightarrow>
                                  \<exists>x. x \<in> \<sigma> \<inter> closed_segment v\<^sub>0 v\<^sub>2
                                    \<and> x \<notin> J'"
                              proof -
                                fix e
                                ...
                                obtain x where hxe: "x \<in> e"
                                  and hx_chord: "x \<in> closed_segment v\<^sub>0 v\<^sub>2"
                                  and hx_not_parent: "x \<notin> J'"
                                  using hL\<^sub>1_side_edge_nonparent_has_off_parent_chord_point
                                ...
                                have hx\<sigma>: "x \<in> \<sigma>"
                                  using hxe he_sub_\<sigma> by (by100 blast)
                                show "\<exists>x. x \<in> \<sigma> \<inter> closed_segment v\<^sub>0 v\<^sub>2
                                  \<and> x \<notin> J'"
                                  using hx\<sigma> hx_chord hx_not_parent by (by100 blast)
                              qed
                              have h\<tau>_side_edge_nonparent_has_off_parent_chord_point:
                                "\<And>e. e \<in> L\<^sub>2 \<Longrightarrow> geotop_is_edge e \<Longrightarrow>
                                  geotop_is_face e \<tau> \<Longrightarrow> e \<subseteq> J\<^sub>2 \<Longrightarrow>
                                  \<not> e \<subseteq> J' \<Longrightarrow>
                                  \<exists>x. x \<in> \<tau> \<inter> closed_segment v\<^sub>0 v\<^sub>2
                                    \<and> x \<notin> J'"
                              proof -
                                fix e
                                ...
                                obtain x where hxe: "x \<in> e"
                                  and hx_chord: "x \<in> closed_segment v\<^sub>0 v\<^sub>2"
                                  and hx_not_parent: "x \<notin> J'"
                                  using hL\<^sub>2_side_edge_nonparent_has_off_parent_chord_point
                                    [OF heL\<^sub>2 he_edge he_face he_sub_J\<^sub>2 he_not_parent]
                                  by (by100 blast)
                                have he_sub_\<tau>: "e \<subseteq> \<tau>"
                                  by (rule geotop_is_face_imp_subset_prefix[OF he_face])
                                have hx\<tau>: "x \<in> \<tau>"
                                  using hxe he_sub_\<tau> by (by100 blast)
                                show "\<exists>x. x \<in> \<tau> \<inter> closed_segment v\<^sub>0 v\<^sub>2
                                  \<and> x \<notin> J'"
                                  using hx\<tau> hx_chord hx_not_parent by (by100 blast)
                              qed
                              ...
                              proof -
                                ...
                                proof -
                                  ...
                                  qed
                                qed
                                have hproper_named_chord_residue_excludes_uncovered_side_witnesses_book:
                                  ...
                                  \<and> (\<forall>x. x \<in> \<tau> \<inter> J' \<longrightarrow>
                                    ...
                                    False)"
                                  (**
                                    Sharpened residual for the two uncovered
                                    side-witness cases: a proper named face of
                                    the cut triangle forced by chord residue
                                    cannot account for an uncovered
                                    parent-boundary point on either transferred
                                    side witness. **)
                                  sorry
                                  ...
                                  proof (intro allI impI)
                                    ...
                                    assume hnamed:
                                      "\<sigma> \<inter> \<theta> \<subseteq>
                                        ...
                                        geotop_convex_hull {v\<^sub>1, v\<^sub>2}"
                                    show False
                                      using hproper_named_chord_residue_excludes_uncovered_side_witnesses_book
